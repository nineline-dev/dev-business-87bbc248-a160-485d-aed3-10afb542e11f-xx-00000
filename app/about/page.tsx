  ...
  return (
    <main className="py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-5xl font-bold text-primary-700 mb-8">About Business 87bbc248-a160-485d-aed3-10afb542e11f</h1>

        <div className="prose prose-lg">
          <p className="text-xl text-gray-700 mb-6">
            With over two decades of experience in business-87bbc248-a160-485d-aed3-10afb542e11f, we've built our reputation on
          ...
          <p className="text-gray-700">
            To provide our clients with trusted, reliable business-87bbc248-a160-485d-aed3-10afb542e11f services that exceed expectations
          ...
          <div className="bg-primary-50 p-8 rounded-lg mt-12">
            ...
            <p className="text-gray-700">
              Ready to work with a trusted business-87bbc248-a160-485d-aed3-10afb542e11f partner? Contact us today to discuss your needs.
            </p>
